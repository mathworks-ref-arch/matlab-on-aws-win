...
```json
{
    ...
    "Statement": [
        ...
        },
        {
            ...
            "Condition": {
                "StringEquals": {
                    "aws:CalledViaFirst": "cloudformation.<<AWS_URL_SUFFIX>>"
                }
            }
        },
        {
...
```json
{
    ...
    "Statement": [
        ...
        },
        {
            ...
            "Resource": "arn:<<AWS_PARTITION>>:logs:<<AWS_REGION>>:<<AWS_ACCOUNT_ID>>:log-group:/aws/lambda/*AttachInstanceProfileLambda*",
            "Effect": "Allow"
        },
        {
            "Action": [
